eagle.define('eagle_theme_ecomm.ks_video_snippts', function(require) {
    "use strict";
    ...
    var data_1
    var attachment_id
    var qweb_modal = ajax.loadXML('/eagle_theme_ecomm/static/src/xml/ks_attach.xml',QWeb);
    var ks_SnippetSelectionDialog = ks_widget.Dialog.extend({
     start: function() {
         ...
         var modal_html =  $(QWeb.render('eagle_theme_ecomm.ks_video_selection', {}));
