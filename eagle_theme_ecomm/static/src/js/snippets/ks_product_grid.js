eagle.define('eagle_theme_ecomm.ks_product_grid', function(require){
  "use strict";
    ...
    var _t = core._t;
    var qweb = core.qweb;
    ajax.loadXML('/eagle_theme_ecomm/static/src/xml/ks_product_grid_snippet.xml', qweb);
    animation.registry.website_sale_product_grid = animation.Class.extend({
        ...
        xmlDependencies: ['/eagle_theme_ecomm/static/src/xml/ks_product_grid_snippet.xml'],
