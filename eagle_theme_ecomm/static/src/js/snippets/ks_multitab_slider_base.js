...
//    });
    ...
    animation.registry.website_sale_mutitab_product_slider_1 = animation.Class.extend({
        ...
        xmlDependencies: ['/eagle_theme_ecomm/static/src/xml/ks_multitab_slider_inside.xml'],
        ...
        start: function(slider_id,ks_self_recived) {
           ...
           self.ks_getmulttabRecords(slider_id,ks_self_recived);
            ajax.loadXML('eagle_theme_ecomm/static/src/xml/ks_multitab_slider_inside.xml', qweb);
             return this._super();
        },
