eagle.define('website_snippet_featured', function(require){
  "use strict";
    ...
    var QWeb = core.qweb;
    ajax.loadXML('/eagle_theme_ecomm/static/src/xml/ks_featured_snippet_inner.xml', QWeb);
    sAnimation.registry.snippet_brands_home_page = sAnimation.Class.extend({
       ...
       xmlDependencies: ['/eagle_theme_ecomm/static/src/xml/ks_featured_snippet_inner.xml'],
       events: {
