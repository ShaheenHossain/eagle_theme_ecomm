eagle.define('ks_theme_website_sale_custom', function (require) {
    ...
    var ks_xmlDef = ajax.loadXML('/eagle_theme_ecomm/static/src/xml/ks_product_grid.xml', core.qweb);
    /*
...
//          this.active=true;
          ...
          ks_ajax =  ajax.jsonRpc("/shop2/products", 'call', {'filters':ks_filters}).then(function (values) {
                ...
                $("#products_grid").empty().append(core.qweb.render('eagle_theme_ecomm.ks_product_grid', {  "products": values}));
                $(".breadcrumb").replaceWith(core.qweb.render('eagle_theme_ecomm.ks_breadcrumb', {  "products": values}));
                $(".pagination").html(core.qweb.render('eagle_theme_ecomm.ks_theme_pagination', {  "products": values}));
                active=false;
            });
         });
     }
        ...
        if($(".is_ks_load_ajax").length > 0){
            ...
            ajax.jsonRpc("/shop2/products", 'call', {'filters':ks_filters}).then(function (values) {
                ...
                _.each($(".pagination"),function(page){
                    $(page).html(core.qweb.render('eagle_theme_ecomm.ks_theme_pagination', {  "products": values}));
                });
            });
        }
        else{
