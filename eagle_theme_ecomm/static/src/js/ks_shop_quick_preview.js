eagle.define('website_product_quick_preview', function(require){
  "use strict";
    //Handling quick preview on the shop page
     ...
     var _t = core._t;
     var ch;
     var qweb_modal = ajax.loadXML('/eagle_theme_ecomm/static/src/xml/modal.xml',QWeb);
    sAnimation.registry.product_quick_preview_template = sAnimation.Class.extend({
       ...
       template: 'product_quick_preview_template',
        ...
        _loadModalTemplate:function(){
            return ajax.loadXML('/eagle_theme_ecomm/static/src/xml/modal.xml',QWeb);
        },
        start: function () {
            var self = this;
            return this._super();
         ...
         ks_onPreviewClick : function(e){
            ...
            var modal_html =  $(QWeb.render('eagle_theme_ecomm.products_modal', {}));
