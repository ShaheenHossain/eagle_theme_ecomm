                ...
                return this._rpc({
                    ...
                    _.each(result, function (item) {
                        ...
                        if ((item.key.indexOf('eagle_theme_ecomm.custom_header_layout')!= -1) ||
                            (item.key.indexOf('eagle_theme_ecomm.ks_button_style_layout')!= -1) ||
                            (item.key.indexOf('eagle_theme_ecomm.custom_font_layout')!= -1) ||
                            (item.key.indexOf('eagle_theme_ecomm.custom_snippet_width')!= -1) ||
                            (item.key.indexOf('eagle_theme_ecomm.custom_footer_layout')!= -1)){
                                       $a.addClass("d-none");
                                       $menu.append($a);
