        ...
        _ksGetLayouts: function(){
           return  this._rpc({
            ...
            _.each(result, function (item) {
                ...
                if (item.key.indexOf('eagle_theme_ecomm.custom_header_layout')!= -1){
                 // put this code for any customization and change the image path for what are you previewing
                    ...
                    if(! $('#ks_img_demo'+suffix) .length){
                        $("#footer").append("<div id='ks_img_demo_header"+suffix+"' class='ks_hover_image_demo'><div class='ks_preview_img'><img src='/eagle_theme_ecomm/static/src/img-ui/headers/h-"+suffix+".png'></img><i class='fa fa-times ks_close_demo_preview'></i><div></div>")
                    }
                ...
                if (item.key.indexOf('eagle_theme_ecomm.custom_footer_layout')!= -1){
                    var suffix = item.key.match(/\d+/);
                    $a.append("<div class='ks_demo_info_footer fa fa-eye' id='ks_info_footer"+suffix+"'></div>")
                    if(! $('#ks_img_demo_footer'+suffix) .length){
                        $("#footer").append("<div id='ks_img_demo_footer"+suffix+"' class='ks_hover_image_demo'><div class='ks_preview_img'><img src='/eagle_theme_ecomm/static/src/img-ui/footers/f-"+suffix+".png'></img><i class='fa fa-times ks_close_demo_preview'></i><div></div>")
                    }
                ...
                if (item.key.indexOf('eagle_theme_ecomm.custom_font_layout')!= -1){
                ...
                if (item.key.indexOf('eagle_theme_ecomm.custom_snippet_width')!= -1){
                    $(".ks_snippet_header").append($a);
                }
                if (item.key.indexOf('eagle_theme_ecomm.ks_button_style_layout')!= -1){
