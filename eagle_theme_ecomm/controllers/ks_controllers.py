...
class WebsiteSale(WebsiteSale):
    ...
    def ks_deal_of_the_day(self):
        value = []
        qty = []
        item_ids = request.env['eagle_theme_ecomm.ks_deal_of_the_day'].sudo().search([]).ks_selected_product.item_ids
        ...
        if (len(qty) > 0):
            if not (len(qty) > 0 and all(elem == qty[0] for elem in qty)):
                ...
                item_ids = request.env['eagle_theme_ecomm.ks_deal_of_the_day'].sudo().search(
    ...
    def ks_beauty(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_beauty')

    @http.route('/fitness', auth='public', website=True)
    def ks_gym(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_gym')

    @http.route('/corporate', auth='public', website=True)
    def ks_corporate(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_corporate')

    @http.route('/medical', auth='public', website=True)
    def ks_medical(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_hospital')

    @http.route('/furniture', auth='public', website=True)
    def ks_furniture(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_furniture')

    @http.route('/food', auth='public', website=True)
    def ks_food(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_food')

    @http.route('/pet', auth='public', website=True)
    def ks_pet_shop(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_pet')

    @http.route('/jewel', auth='public', website=True)
    def ks_jewellery_shop(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_jewellery')

    @http.route('/watch', auth='public', website=True)
    def ks_watch_shop(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_watch')

    @http.route('/about', auth='public', website=True)
    def ks_about(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_about_us')

    @http.route('/team', auth='public', website=True)
    def ks_team(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_team')

    @http.route('/price', auth='public', website=True)
    def ks_price(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_pricing')

    @http.route('/services', auth='public', website=True)
    def ks_services(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_services')

    @http.route('/books', auth='public', website=True)
    def ks_services(self, **kw):
        return http.request.render('eagle_theme_ecomm.ks_theme_books')
