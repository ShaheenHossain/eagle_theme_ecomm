...
class WebsiteShopBrands(http.Controller):
    ...
    def KsWriteUpdatedScss(self, **kw):
        if kw.get('color',False):
            ...
            f.write(kw['color']+'\n'+kw['theme_textcolor'])
            f.close()
            self.createQwebIfNotAvialable('eagle_theme_ecomm.ks_updated_color_' + str(request.website.id),
    ...
    def KsWriteUpdatedButtonScss(self, **kw):
        if kw.get('textcolor',False):
            ...
            f.close()
            self.createQwebIfNotAvialableButton('eagle_theme_ecomm.ks_updated_button_color_'+str(request.website.id),'ks_updated_button_color_'+str(request.website.id))
            ...
            f.close()
            self.createQwebIfNotAvialableButton('eagle_theme_ecomm.ks_updated_button_color_' + str(request.website.id),
    ...
    def KsWriteUpdatedhoverScss(self, **kw):
        if kw.get('hovertextcolor', False):
            ...
            f.close()
            self.createQwebIfNotAvialableHover('eagle_theme_ecomm.ks_updated_hover_color_' + str(request.website.id),
    ...
    def active_current_website_css(self, key):
        all_css_templates = request.env['ir.ui.view'].search([('key', 'like', 'eagle_theme_ecomm.ks_updated_color_'), ('active', '=', True)])
        ...
        current_css_tempalte = all_css_templates.search([('key', '=', 'eagle_theme_ecomm.ks_updated_color_' + str(currnt_website_id)),
        ...
        if current_css_tempalte:
            ...
            res = all_css_templates.search(
                [('key', '=', 'eagle_theme_ecomm.ks_updated_color'),
    ...
    def active_current_website_buttoncss(self, key):
        all_css_templates = request.env['ir.ui.view'].search(
            [('key', 'like', 'eagle_theme_ecomm.ks_updated_button_color_'), ('active', '=', True)])
        currnt_website_id = request.website.id
        for template in all_css_templates:
            if template.active:
                template.write({
        ...
        current_css_tempalte = all_css_templates.search(
            [('key', '=', 'eagle_theme_ecomm.ks_updated_button_color_' + str(currnt_website_id)),
             ('active', '=', False), ('website_id', '=', currnt_website_id)])
        ...
        if current_css_tempalte:
            ...
            res = all_css_templates.search(
                [('key', '=', 'eagle_theme_ecomm.ks_updated_button_color'),
                 ('active', 'in', True) or ('active', 'in', False)])
            if res:
                res.write(
                    {'active': True, })
    ...
    def active_current_website_hovercss(self, key):
        all_css_templates = request.env['ir.ui.view'].search(
            [('key', 'like', 'eagle_theme_ecomm.ks_updated_hover_color_'), ('active', '=', True)])
        currnt_website_id = request.website.id
        for template in all_css_templates:
            if template.active:
                template.write({
        ...
        current_css_tempalte = all_css_templates.search(
            [('key', '=', 'eagle_theme_ecomm.ks_updated_hover_color_' + str(currnt_website_id)),
             ('active', '=', False), ('website_id', '=', currnt_website_id)])
        ...
        if current_css_tempalte:
            ...
            res = all_css_templates.search(
                [('key', '=', 'eagle_theme_ecomm.ks_updated_hover_color'),
                 ('active', 'in', True) or ('active', 'in', False)])
            if res:
                res.write(
                    {'active': True, })
    ...
    def createQwebIfNotAvialable(self, key, file_name):
        ...
        if qweb:
            ...
            view_arch = '''<data>
                        ...
                        <link rel="stylesheet" type="text/scss" href="/eagle_theme_ecomm/static/src/css/%s.scss"/> 
                        </xpath>
                        </data>''' % (file_name)
    ...
    def createQwebIfNotAvialableButton(self, key, file_name):
        ...
        if qweb:
            ...
            view_arch = u'<data>' \
                        ...
                        u'      <link rel="stylesheet" type="text/scss" href="/eagle_theme_ecomm/static/src/css/%s.scss"/>' \
                        u'  </xpath>' \
                        u'</data>' % (file_name)
    ...
    def dynamic_font(self, **kwargs):
        try:
            ...
            count = max([int(i.key.split('_')[-1]) for i in request.env['ir.ui.view'].search([('key', 'like', 'eagle_theme_ecomm.custom_font_layout_%'), ('active', 'in', [1, ''])])])
            count += 1
            ...
            g.write(data)
            g.close()
            self.createQwebIfNotAvialableForFont('eagle_theme_ecomm.custom_font_layout_' + str(count),  'font_' + str(count), font_family)
    ...
    def createQwebIfNotAvialableForFont(self, key, file_name, font_family):
        ...
        if qweb:
            ...
            view_arch = u'<data>' \
                        u'  <xpath expr="." position="inside">' \
                        u'      <link rel="stylesheet"type="text/scss"href="/eagle_theme_ecomm/static/src/scss/fonts/%s.scss"/>' \
                        u'  </xpath>' \
                        u'</data>' % (file_name)
